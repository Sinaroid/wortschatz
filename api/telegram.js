...
const sendDraft = (chatId, text) =>
  tgCall('sendMessageDraft', { chat_id: chatId, text, parse_mode: 'HTML' })

const setMenuButton = (chatId) =>
  tgCall('setChatMenuButton', {
    chat_id: chatId,
    menu_button: { type: 'web_app', text: '🇩🇪 Wortschatz', web_app: { url: APP_URL } }
  })
